...
beach_weekend_for_john=Event.create!(user:john, event_name:"Beach Weekend", event_description:"Long weekend with the family",event_location:"NJ shore", event_contact:"Jean Brown", event_start: DateTime.parse("5 June 2022"),event_end: DateTime.parse("8 June 2022"),private: false)
job_search_for_john=Event.create!(user:john, event_name:"Find Job", event_description:"Get Job",event_location:"Home", event_contact:"Me", event_start: DateTime.parse("1 June 2022"),event_end: DateTime.parse("8 June 2022"),private: false )
